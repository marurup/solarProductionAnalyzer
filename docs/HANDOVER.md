...
- ✅ **Trin-omstrukturering (1, 1½, 2 → 1, 2, 3)** — det tidligere ulogiske "trin 1½" (adresse-quick-konfig som eget kort) er fjernet. Ny inddeling: **1 Importér data · 2 Sæt tariffer (køb + salg) · 3 Analysér.** Adresse-genvejen er flyttet ind i tarif-trinnet som et under-panel ("Genvej: udfyld via adresse"), da den er en genvej til at udfylde tarifferne. Køb/salg-opdeling tydeliggjort med underoverskrifter ("Køb — når du selvforbruger" / "Salg — fradrag på eksportprisen"). Rene DOM-flytninger, ingen JS-ændringer, alle element-ID'er bevaret.
